...
persistent_directory = os.path.join(db_dir, "chroma_db_with_rag")
...
## FIX: kwargs.get chat_history not working, can't get from kwargs
tools = [
    Tool(
        name="Answer Question",
        func=lambda input, **kwargs: rag_chain.invoke(
            {"input": input, "chat_history": kwargs.get("chat_history", chat_history)}
        ),
